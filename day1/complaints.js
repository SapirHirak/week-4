...
let complaint1 = {
    ...
    type: consts.obj.FINANCE//use the FINANCE type from the consts module
}

let complaint2 = {
    text: "My salary hasn't come in yet",
    type: consts.obj.WEATHER//use the FINANCE type from the consts module
}

let complaint3 = {
    text: "I'm always full of energy",
    type: consts.obj.EMOTIONS//use the EMOTIONS type from the consts module
}
